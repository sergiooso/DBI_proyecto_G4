...
public class Paciente {
	...
	public Paciente(int id_Paciente, String pri_Nombre, String seg_Nombre, String pri_Apellido, String seg_Apellido,
			String telefono, String correo, String direccion, Date fecha_Nac, String contrasenia, List<Expediente> expediente,
			List<Receta_Medica> receta_medica, List<Factura> factura, List<Consulta> consulta) {
		super();
